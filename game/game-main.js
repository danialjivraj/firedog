...
import {
    ...
    Piranha, SkeletonFish, SpearFish, JetFish, Piper, Jellion, Voltzeel, Garry,
    ...
    addEnemy() {
        ...
        const enemyTypes = {
            ...
            Map4: [
                ...
                { type: SpidoLazer, probability: 0.01, spawningDistance: 70 },
            ...
            Map6: [
                ...
                { type: Mycora, probability: 0.05, spawningDistance: 0 },
