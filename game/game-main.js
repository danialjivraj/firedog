...
// ------------------------------------------------------------ Game Class logic ------------------------------------------------------------
        ...
        update(deltaTime) {
            if (!this.menu.pause.isPaused) {
                ...
                const enemyAudioMapping = [
                    ...
                    { enemyType: RunningSkeletonSizes, audio: 'fuseSound' },
                    { enemyType: PurpleSpider, audio: 'purpleSpiderWalking' },
                    { enemyType: Goblin, audio: 'goblinRunSound' },
                    { enemyType: VerticalGhost, audio: 'verticalGhostSound' },
                    { enemyType: JetFish, audio: 'rocketLauncherSound' },
                    { enemyType: SpearFish, audio: 'stepWaterSound' },
                    { enemyType: DollGhost, audio: 'dollHumming' },
        ...
        addEnemy() {
            ...
            const enemyTypes = {
                ...
                Map2: [
                    { type: Goblin, probability: 0.05, spawningDistance: 0 },
                    { type: VerticalBat, probability: 0.1, spawningDistance: 0 },
                    { type: NightPlant, probability: 0.2, spawningDistance: 0 },
                    { type: NightSpider, probability: 0.4, spawningDistance: 0 },
                    { type: GhostEnemy, probability: 0.2, spawningDistance: 0 },
                    { type: VerticalGhost, probability: 0.2, spawningDistance: 0 },
                    { type: DollGhost, probability: 0.01, spawningDistance: 100 },
                ],
                Map3: [
                    { type: Goblin, probability: 0.05, spawningDistance: 0 },
                ...
                Map4: [
                    { type: Goblin, probability: 0.05, spawningDistance: 0 },
                    { type: BigSlug, probability: 0.3, spawningDistance: 0 },
                    { type: GreenPlant, probability: 0.2, spawningDistance: 0 },
                    { type: GreenFlappyBird, probability: 0.2, spawningDistance: 0 },
                    { type: LilHornet, probability: 0.05, spawningDistance: 0 },
                    { type: KarateCroco, probability: 0.05, spawningDistance: 0 },
                    { type: Frog, probability: 0.01, spawningDistance: 80 },
                    { type: PurpleSpider, probability: 0.01, spawningDistance: 100 },
                    { type: FlyingBomber, probability: 0.05, spawningDistance: 100 },
                ],
                Map5: [
                    { type: Goblin, probability: 0.05, spawningDistance: 0 },
                    { type: SpikeySnail, probability: 0.05, spawningDistance: 0 },
                    { type: OneEyeFly, probability: 0.2, spawningDistance: 0 },
                    { type: PurpleFly, probability: 0.2, spawningDistance: 0 },
                ...
                Map6: [
                    ...
                    { type: RedOneEyeFly, probability: 0.5, spawningDistance: 0 },
                    { type: Turtle, probability: 0.1, spawningDistance: 0 },
