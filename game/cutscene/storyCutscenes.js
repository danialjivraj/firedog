...
export class Map1Cutscene extends StoryCutscene {
    constructor(game) {
        ...
        this.addDialogue(
            `${this.firedog}`,
            `TEST: Normal + ? + !`,
            this.addImage(this.setfiredogNormalQuestionAndExlamationMark(), LEFT),
        );
        ...
        this.addDialogue( //49
            ...
            this.addImage('quilzorinNormal', LEFT),
            this.addImage('galadonScared', RIGHT),
        );
        this.addDialogue( //50
            `${this.quilzorin}`,
        ...
        this.addDialogue( //52
            ...
            this.addImage('quilzorinExplaining', LEFT),
            this.addImage('galadonAmazed', RIGHT),
        );
        this.addDialogue( //53
            `${this.galadon}`,
        ...
        this.addDialogue( //132 scenary switch
            ...
            this.addImage(this.setfiredogNormal(), LEFT),
            this.addImage('quilzorinHandUp', RIGHT),
        );
        ...
        this.addDialogue( //135
            ...
            this.addImage(this.setfiredogNormal(), LEFT),
            this.addImage('quilzorinExplaining', RIGHT),
        );
...
export class Map1EndCutscene extends StoryCutscene {
    constructor(game) {
        ...
        this.addDialogue( //38
            `${this.duskmaw}`,
            `Many people died before a peace treaty was proposed. Nowadays the biggest land belongs to ${this.lunarGlade}.`,
            this.addImage(this.setfiredogNormal(), LEFT),
            this.addImage('duskmawNormal', RIGHT),
        );
        this.addDialogue( //39
...
export class Map4Cutscene extends StoryCutscene {
    constructor(game) {
        ...
        this.addDialogue( //86
            ...
            this.addImage('quilzorinSurprised', LEFT),
            this.addImage('valdorinCrossedArms', RIGHT),
        );
        this.addDialogue( //87
            `${this.valdorin}`,
        ...
        this.addDialogue( //90
            `${this.valdorin}`,
            `One of our sorcerers had came up with a solution. Currently, ${this.lunarGlade} is surrounded by a protective layer built by our sorcerers.`,
            this.addImage('quilzorinNormal', LEFT),
            this.addImage('ValdorinTalking', RIGHT),
        );
        this.addDialogue( //91
        ...
        this.addDialogue( //104
            ...
            this.addImage('quilzorinScared', LEFT),
            this.addImage('valdorinFistUp', RIGHT),
        );
        this.addDialogue( //105
            `${this.valdorin}`,
...
export class Map5EndCutscene extends StoryCutscene {
    constructor(game) {
        ...
        this.addDialogue( //18
            `${this.firedog}`,
            `But only the higher-ups inside ${this.lunarGlade} know where the ${this.temporalTimber} is.`,
            this.addImage(this.setfiredogNormal(), LEFT),
        );
        this.addDialogue( //19
            `${this.firedog}`,
            `So perhaps whoever did this, used to, or still does live in ${this.lunarGlade}?`,
            this.addImage(this.setfiredogCurious(), LEFT),
        );
        this.addDialogue( //20
            `${this.firedog}`,
        ...
        this.addDialogue( //26
            `${this.firedog}`,
            `I'm starting to think that it cannot be a coincidence that the dreams and visions started happening right after I left ${this.lunarGlade}.`,
            this.addImage(this.setfiredogNormal(), LEFT),
        );
        this.addDialogue( //27
            `${this.firedog}`,
        ...
        this.addDialogue( //31
            ...
            `Hmm... Focus...`,
            this.addImage(this.setfiredogTired(), LEFT),
            this.addImage("scrollLetterMessageGaladonClosed", { x: 705, y: 465, width: 108, height: 75 })
        );
        this.addDialogue( //32
            `${this.firedog}`,
            `... ... ...`,
