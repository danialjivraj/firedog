...
export class EnemyLore extends BaseMenu {
    constructor(game) {
        ...
        //3
        this.createPage("VERTIBAT", "FALL & NORMAL", "LUNAR MOONLIT GLADE", "THESE BATS ARE COMMONLY FOUND IN NIGHTFALL CITY PHANTOM, HOWEVER, SOMETHING CAUSED MOST OF THEM TO MIGRATE "
            + "TO LUNAR MOONLIT GLADE.\nIT IS SPECULATED THAT VERTIBATS CAN DETECT FREQUENCIES NO OTHER CREATURE CAN, INCLUDING PARANORMAL FREQUENCY, WHICH PROBABLY CAUSED "
